    ...
    return (
      <>
        ...
        {/* <div className="my-0.5 w-28 md:w-full h-8 px-2 md:px-2.5 flex">
          <iframe
            src="https://github.com/sponsors/amanmehtacode/button"
            title="Sponsor amanmehtacode"
            width={"100%"}
            height={"100%"}
          ></iframe>
        </div> */}
  ...
  return (
    <>
      ...
      <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
        <div>
          my name is <span className="font-bold">Aman Mehta</span> ,
        </div>
      ...
      <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
        <li className=" list-pc">
          I'm a <span className=" font-medium">Undergraduate Student</span>{" "}
          currently pursuing Bachelors in Computer Science. I've completed my 6
          month SWE intern at{" "}
          ...
          up{" "}
          <a className="text-underline" href="mailto:amehta20@nyit.edu">
            <u>amehta20@nyit.edu</u>
          </a>{" "}
          :) )
        </li>
      ...
      <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
        <li className="list-disc">
          <div className=" text-lg md:text-xl text-left font-bold leading-tight">
            New York Institute or Technology
          </div>
